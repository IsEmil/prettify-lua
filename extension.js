...
herrtts.command = "prettify-lua.luamin";
...
function activate(context) {
	...
	let luamin = vscode.commands.registerCommand('prettify-lua.luamin', function() {
		...
		const settings = vscode.workspace.getConfiguration('prettify-lua')
